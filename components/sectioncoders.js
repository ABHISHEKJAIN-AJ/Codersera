const SectionCoders = () => (<div className="section-coders">
    <div className="section-coders-div">
        <div className="section-coders-heading">
            Connect With Top Developers anytime.
        </div>
        <div className="section-coders-bg"></div>
                ...
                <div className="section-coders-content-coder">
                    ...
                    <div className="section-coders-content-coder-details coder1-detail-position">
                        ...
                        <div className="coder-det">
                            <div className="coder-det-2">React</div>
                            <div className="coder-det-2">Node</div>
                        </div>
                        <div className="coder-det-1">python</div>
                        <div className="coder-det">
                            <div className="coder-det-2">c++</div>
                            <div className="coder-det-2">ruby</div>
                        </div>
                        <div className="coder-det-1">next</div>
                        <div className="coder-profile">View Profile  ></div>
                    </div>
                </div>
                <div className="section-coders-content-coder">
